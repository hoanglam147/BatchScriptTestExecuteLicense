...
echo %mydate%-%mytime%
@call "C:\Program Files (x86)\SmartBear\TestExecute 14\x64\Bin\TestExecute.exe" "C:\Users\test\DiskDriveD\GIT\dl.code\SVN_TestComplete\TC_DLCODE\DL.CODE\DL.CODE\DL.CODE.mds" /r /p:DL.CODE /t:"Script|IconOnToolBar|iconToolbarJazz" /SilentMode /exportLog:"C:\Users\test\DiskDriveD\DL.CODE.Log\%mydate%-%mytime%-%~n0\summary.html" /e
